...
#'           do_path = "~/project/STATA load programs/StataLoad_NIS_2021_Hospital.Do",
#'           asc_path = "~/project/data/ASCII/NIS_2021_Hospital.ASC",
#'           output_direct = "~/project/data")
#' }

load_nis_hospital <- function(do_path, asc_path, output_direct) {
